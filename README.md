...
[bcut](https://bcut.bilibili.cn) | 必剪，B站官方出品。 | [3.2.0](https://github.com/jat001/scoop-ox/tree/master/bucket/bcut.json) | [Freeware]()
...
[heybox-acc](https://acc.xiaoheihe.cn) | 小黑盒加速器，告别高延迟，畅玩海外游戏。 | [1.1.19.1](https://github.com/jat001/scoop-ox/tree/master/bucket/heybox-acc.json) | [Freeware]()
[heybox-workshop](https://workshop.xiaoheihe.cn) | 黑盒工坊是一款专为魔兽玩家定制、永久免费的插件管理软件。 | [1.9.8.1](https://github.com/jat001/scoop-ox/tree/master/bucket/heybox-workshop.json) | [Freeware]()
[oraclejdk](https://www.oracle.com/java/) | Oracle Java SE Development Kit | [19.0.1](https://github.com/jat001/scoop-ox/tree/master/bucket/oraclejdk.json) | [Freeware](https://www.oracle.com/downloads/licenses/no-fee-license.html)
...
[sublime-merge-dev](https://www.sublimemerge.com/dev) | A Git client with snappy UI, three-way merge tool, side-by-side diffs, syntax highlighting, and more. (Dev version) | [2078](https://github.com/jat001/scoop-ox/tree/master/bucket/sublime-merge-dev.json) | [Shareware](https://www.sublimehq.com/eula)
[sublime-text-dev](https://www.sublimetext.com) | A sophisticated text editor for code, markup and prose. (ST4 dev veriosn) | [4141](https://github.com/jat001/scoop-ox/tree/master/bucket/sublime-text-dev.json) | [Shareware](https://www.sublimetext.com/eula)
...
[wechat-work](https://work.weixin.qq.com) | WeCom is a professional office management tool created by Tencent WeChat team for companies. | [4.0.19.6020](https://github.com/jat001/scoop-ox/tree/master/bucket/wechat-work.json) | [Freeware](https://work.weixin.qq.com/nl/eula)
[wowup](https://wowup.io) | World of Warcraft addon updater. | [2.9.1](https://github.com/jat001/scoop-ox/tree/master/bucket/wowup.json) | [GPL-3.0-or-later](https://github.com/WowUp/WowUp/blob/master/LICENSE)
[wowup-beta](https://wowup.io) | World of Warcraft addon updater. (Beta version) | [2.9.2-beta.4](https://github.com/jat001/scoop-ox/tree/master/bucket/wowup-beta.json) | [GPL-3.0-or-later](https://github.com/WowUp/WowUp/blob/master/LICENSE)
<!-- Generated by bin\updateReadme.ps1, do not edid it manually. -->
